...
export default function ToolbarPlugin({
  ...
  const updateToolbar = useCallback(() => {
    ...
    setState({
      ...
      isBulletList: $isListNode(element) && element.getListType() === "bullet",
      isNumberedList:
  ...
  return (
    <div className="flex bg-whatsapp-primary/10 items-center gap-0.5 px-2 py-1.5 border-b border-border flex-wrap rounded-t-xl">
      {/* Undo / Redo */}
      {btn(
        false,
